...
# ---- single frame ----
python test.py --cfg_file ../model_zoo/lyft_pretrained/cfgs/lyft_voxel_rcnn_centerhead_1f_xyz_allcls.yaml \
                --ckpt ../model_zoo/lyft_pretrained/lyft_voxel_rcnn_centerhead_1f_xyz_allcls.pth \
