...
# ---- single frame ----
python test.py --cfg_file ../model_zoo/lyft_pretrained/cfgs/lyft_pv_rcnn_plusplus_resnet_centerhead_1f_xyz_allcls.yaml \
                --ckpt ../model_zoo/lyft_pretrained/lyft_pv_rcnn_plusplus_resnet_centerhead_1f_xyz_allcls.pth \
...
python test.py --cfg_file ../model_zoo/lyft_pretrained/cfgs/lyft_pv_rcnn_plusplus_resnet_centerhead_3f_xyzt_allcls.yaml \
