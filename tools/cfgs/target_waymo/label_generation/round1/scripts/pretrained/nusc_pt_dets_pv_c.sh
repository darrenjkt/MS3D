...
# ---- single frame ----
python test.py --cfg_file ../model_zoo/nuscenes_pretrained/cfgs/nuscenes_pv_rcnn_plusplus_resnet_centerhead_10f_xyzt_allcls.yaml \
                --ckpt ../model_zoo/nuscenes_pretrained/nuscenes_pv_rcnn_plusplus_resnet_centerhead_10f_xyzt_allcls.pth \
