...
if __name__ == '__main__':
    ...
    #                                                           ps_score_th=args.pos_th_veh, kdebox_min_score=args.min_static_score)  # 23:20MIN for 18840
    ...
    tracks_veh_static_pth = '/MS3D/tools/cfgs/target_waymo/ps_labels/tracks_static_world_proprkde.pkl'
    ps_dict = load_pkl(ps_pth)
    tracks_veh_all = load_pkl(tracks_veh_all_pth)
    tracks_veh_static = load_pkl(tracks_veh_static_pth)
