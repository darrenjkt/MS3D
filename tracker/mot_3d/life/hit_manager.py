...
class HitManager:
    def __init__(self, configs, frame_index):
        ...
        self.max_redundancy_age = configs['redundancy']['max_redundancy_age']
        ...
        # If begining frames of the sequence, just assign "alive" to the box
    ...
    def update(self, update_info: UpdateInfoData, is_key_frame=True):
        ...
        if association != 0:
            ...
            if association == 1: # detection > score_th
                self.time_since_det = 0
    ...
    def state_transition(self, mode, frame_index):
        ...
        # already alive
            ...
            if self.time_since_det >= self.max_redundancy_age:
                self.state = 'dead'
