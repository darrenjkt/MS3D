...
def get_evaluation_results(gt_annos, pred_annos, classes,
    ...
    all_precision, all_recall, all_confusion, all_thresholds, all_all_scores = [], [], [], [], []
    ...
    if return_pr:
        return ret_str, ret_dict, all_confusion, all_precision, all_recall, all_thresholds, all_all_scores
    else:
